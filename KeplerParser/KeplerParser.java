	...
	public class GraphPanel extends JPanel{
		...
		public void paintComponent(Graphics g){
			...
			if(data != null){
				...
				//at some point maybe make it draw maxpoints for scrolling too
				if(scrolling){
					int scrollamt = (int)(((data.size()*(rightGraph-leftGraph))/ (data.get(data.size()-1).getTime() - data.get(0).getTime()))/getWidth());
